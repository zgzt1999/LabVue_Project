<template>
  <div>
    ...
    <br />
    <el-button @click="allStart()" :disabled="disabled"size="small">全部开始</el-button>
    <el-button @click="allStop()" style="margin-left: 4px"size="small">全部暂停</el-button>
    <el-button @click="allRemove()" style="margin-left: 4px"size="small">全部移除</el-button>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      skip: false,
      options: {
        target: "//192.168.31.106:8084/upload/chunk",
        // 开启服务端分片校验功能
        testChunks: true,
  ...
  methods: {
    fileSuccess(rootFile, file, response, chunk) {
      ...
      if (result.success && !this.skip) {
        axios
          .post(
            "http://192.168.31.106:8084/upload/merge",
            {
